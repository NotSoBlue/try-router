...
const LoadBookingDetails = lazy(() => import('./Components/BookDetails'));
const LoadSearchPage = lazy(() => import('./Components/SearchPage'));
    ...
    return (
      <div className='app'>
        ...
        {/* Book Details Route */}
          <Route
            path='/details/:bookId'
            render={props => <LoadBookingDetails {...props}/>}
          />
